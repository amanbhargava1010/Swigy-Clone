  ...
  return (
    <div className="text-center">
      ...
      {categories.map((category,index) => {
        return (
          // If the parent is controlling a component it is called as the Controlled Component. 
          // just for opening the first one open we are seting the showItems state. 
